...
const ES = {
  ...
  'capas.borrarMensaje': 'La capa «{nombre}» tiene {n} elemento(s). No se van a borrar: pasan a la capa «{destino}».',
  ...
  'campos.notaFirma': 'Se coloca directo en la hoja. No entra al catálogo porque no se repite.',
...
const EN: Record<ClaveI18n, string> = {
  ...
  'capas.borrarMensaje': 'Layer “{nombre}” holds {n} element(s). They will not be deleted: they move to layer “{destino}”.',
  ...
  'campos.notaFirma': 'Placed straight onto the sheet. It does not join the catalogue because it is not repeated.',
...
const PT: Record<ClaveI18n, string> = {
  ...
  'capas.borrarMensaje': 'A camada «{nombre}» tem {n} elemento(s). Não serão excluídos: passam para a camada «{destino}».',
  ...
  'campos.notaFirma': 'Vai direto para a folha. Não entra no catálogo porque não se repete.',
