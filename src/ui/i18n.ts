...
const ES = {
  ...
  'menu.pagina.convertirFormas': 'Convertir las formas del PDF…',
  'confirmar.convertirFormas.titulo': 'Convertir las formas del PDF',
  'confirmar.convertirFormas.mensaje': 'Se van a sacar del PDF sus {n} líneas y recuadros, y a quedar como elementos del diseño: se pueden mover, cambiar de color y borrar. El texto y los campos no se tocan. Se puede deshacer con Ctrl+Z.',
  'confirmar.convertirFormas.aceptar': 'Convertir',
  'aviso.formasConvertidas': '{n} formas del PDF convertidas en elementos',
  'aviso.sinFormas': 'Este PDF no tiene líneas ni recuadros para convertir',
...
const EN: Record<ClaveI18n, string> = {
  ...
  'menu.pagina.convertirFormas': 'Convert the PDF shapes…',
  'confirmar.convertirFormas.titulo': 'Convert the PDF shapes',
  'confirmar.convertirFormas.mensaje': 'Its {n} lines and boxes will be taken out of the PDF and become design elements: you can move them, recolor them and delete them. Text and fields are left alone. You can undo with Ctrl+Z.',
  'confirmar.convertirFormas.aceptar': 'Convert',
  'aviso.formasConvertidas': '{n} PDF shapes turned into elements',
  'aviso.sinFormas': 'This PDF has no lines or boxes to convert',
...
const PT: Record<ClaveI18n, string> = {
  ...
  'menu.pagina.convertirFormas': 'Converter as formas do PDF…',
  'confirmar.convertirFormas.titulo': 'Converter as formas do PDF',
  'confirmar.convertirFormas.mensaje': 'Suas {n} linhas e caixas vão sair do PDF e virar elementos do modelo: dá para movê-las, mudar a cor e apagá-las. O texto e os campos não são tocados. Dá para desfazer com Ctrl+Z.',
  'confirmar.convertirFormas.aceptar': 'Converter',
  'aviso.formasConvertidas': '{n} formas do PDF convertidas em elementos',
  'aviso.sinFormas': 'Este PDF não tem linhas nem caixas para converter',
